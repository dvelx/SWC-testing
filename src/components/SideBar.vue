<template>
  <div class="sidebar">
    <h1 class="sidebar__title">Demo Test</h1>
    <div class="sidebar__navigation">
      <div class="sidebar__btn">
        ...
        <p class="sidebar__btn-title">Profile</p>
      </div>
      <div class="sidebar__btn">
        <svg
          width="24"
        ...
        <p class="sidebar__btn-title">Vehicles</p>
      </div>
      <div class="sidebar__btn">
        <svg
          width="24"
        ...
        <p class="sidebar__btn-title">Setting</p>
      </div>
    </div>
  </div>
</template>
...
.sidebar {
  ...
  &__btn {
    ...
    &:hover {
      background-color: $text_white_20;
